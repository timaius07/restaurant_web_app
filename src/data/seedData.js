...
export const PRODUCTOS = [
  { id: '1', nombre: 'Patacones con Natilla', descripcion: 'Patacones fritos con natilla casera', precioUnitario: 2500, categoriaId: '1', activo: true },
  { id: '2', nombre: 'Ceviche de Camarón', descripcion: 'Camarón fresco en limón con culantro', precioUnitario: 4500, categoriaId: '1', activo: true },
  { id: '3', nombre: 'Casado con Pollo', descripcion: 'Arroz, frijoles, ensalada, maduro y pollo', precioUnitario: 5500, categoriaId: '2', activo: true },
  { id: '4', nombre: 'Casado con Carne', descripcion: 'Arroz, frijoles, ensalada, maduro y carne molida', precioUnitario: 6000, categoriaId: '2', activo: true },
  { id: '5', nombre: 'Casado Vegetariano', descripcion: 'Arroz, frijoles, ensalada y vegetales salteados', precioUnitario: 4800, categoriaId: '2', activo: true },
  { id: '6', nombre: 'Fresco de Tamarindo', descripcion: 'Bebida natural de tamarindo', precioUnitario: 1200, categoriaId: '3', activo: true },
  { id: '7', nombre: 'Fresco de Chan', descripcion: 'Bebida refrescante de chan con limón', precioUnitario: 1200, categoriaId: '3', activo: true },
  { id: '8', nombre: 'Refresco Natural', descripcion: 'Refresco del día', precioUnitario: 1000, categoriaId: '3', activo: true },
  { id: '9', nombre: 'Tres Leches', descripcion: 'Porción de torta tres leches casera', precioUnitario: 2000, categoriaId: '4', activo: true },
  { id: '10', nombre: 'Flan de Coco', descripcion: 'Flan cremoso de coco con caramelo', precioUnitario: 1800, categoriaId: '4', activo: true },
  { id: '11', nombre: 'Sopa Negra', descripcion: 'Sopa de frijoles negros con huevo y tortillas', precioUnitario: 3000, categoriaId: '5', activo: true },
];
